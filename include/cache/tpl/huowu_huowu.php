...
<html lang="zh-CN">
    <head>
        ...
        <![endif]-->
         ...
         <link href="/skin/default/css/huowu.css" rel="stylesheet">
    </head>
    <body>
        ...
        <ul class="nav navbar-nav">
            ...
            <div class="content">
                ...
                <div class="header-title">
                    <img src="/skin/default/images/custom-icon.png" height="15"> <span><?php echo $parent['classname'] ?></span>
                ...
                <div class="caozuo-body">
                    <div class="hw_body">
                        <?php $i=1; ?>
                        <?php $vn=0;$tablev=syClass("syModel")->findSql("select id,tid,sid,title,style,trait,gourl,addtime,hits,htmlurl,htmlfile,orders,mrank,mgold,isshow,keywords,description,bx_image from s_huowu a left join s_huowu_field b on (a.id=b.aid) where isshow=1 and tid in(".$type["tid_leafid"].")  order by id asc ");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["url"]=html_url("channel",$v,0,0,huowu); $v["title"]=stripslashes($v["title"]); $v["description"]=stripslashes($v["description"]); ?>
                            <div class="hw_content <?php if ($i%3 != 1):?>margin-left<?php endif;?> ">
                                <img src="<?php echo $v['bx_image'] ?>">
                                <p class="hw_title text-center"><?php echo $v['title'] ?></p>
                            </div>
                            <?php $i++; ?>
                        <?php } ?>
                    </div>
    ...
    <p class="text-center" ><img src="/skin/default/images/weibo-icon.jpg" >&nbsp;微博：上海恩原 &nbsp;&nbsp;<img src="/skin/default/images/weixin-icon.jpg" >&nbsp;服务号：上海恩原</p>
    <p class="text-center">版权所有@&nbsp;&nbsp;2014-2015&nbsp;&nbsp;上海恩原国际物流有限公司&nbsp;&nbsp;沪ICP备06022390号-1</p>
    </div>
</div>
        </div>
