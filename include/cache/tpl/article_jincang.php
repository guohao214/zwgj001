...
<html lang="zh-CN">
    <head>
        ...
        <![endif]-->
         ...
         <link href="/skin/default/css/jincang.css" rel="stylesheet">
    </head>
    <body>
        ...
        <ul class="nav navbar-nav">
            ...
            <div class="content">
                ...
                <div class="caozuo-body">
                    <!--<iframe src="http://180.168.44.186:5751/ktlogis/ebooking/FRMECCHWPGRID.ASPX" id="traceframe" scrolling="no" frameborder="0" width="100%" height="480px"></iframe>-->
                    <iframe src="http://180.168.40.78:6372/KTLOG/ebooking/FRMECCHWPGRID.ASPX" id="traceframe" scrolling="no" frameborder="0" width="100%" height="480px"></iframe>
                </div>
